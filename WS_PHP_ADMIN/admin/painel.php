...
<html lang="pt-br">
    ...
    <body class="painel">
        ...
        <div id="painel">
            ...
            //QUERY STRING
            if (!empty($_GET['exe'])):
                $includepatch = __DIR__ . '\\_controll\\' . strip_tags(trim($_GET['exe']) . '.php');
            else:
                $includepatch = __DIR__ . '\\_controll\\home.php';
            endif;
            ...
            if (file_exists($includepatch)):
                ...
                EchoMsg("Erro ao incluir tela", "Erro ao incluir o controller /{$_GET['exe']}.php!", ERROR);
                echo "</div>";
            endif;
            ?>
        </div> <!-- painel -->
